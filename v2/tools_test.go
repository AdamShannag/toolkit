...
// Build a custom http client, without requiring a remote API to be active
...
var slugTests = []struct {
	...
	{name: "japanese string and roman charachters", s: "hello world こんにちは世界", expected: "hello-world", errorExpected: false},
}
...
func Test_Tools_DownloadStaticFile(t *testing.T) {
	...
	testTool.DownloadStaticFile(rr, req, "./testdata/pick.jpg", "puppy.jpg")
